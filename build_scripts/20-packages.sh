...
dnf config-manager addrepo --from-repofile="https://pkgs.tailscale.com/stable/fedora/${MAJOR_VERSION_NUMBER}/tailscale.repo"
...
dnf -y copr enable che/nerd-fonts "fedora-${MAJOR_VERSION_NUMBER}-$(arch)"
